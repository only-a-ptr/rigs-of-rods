/**
    ...
    Extracted From: http://www.ogre3d.org/tikiwiki/Euler+Angle+Class
*/
#pragma once
...
@author http://www.ogre3d.org/tikiwiki/Euler+Angle+Class
...
public:
    ...
    */
    ...
    {
        orientation(src.GetYaw(), src.GetPitch(), src.GetRoll());
        return *this;
    }
