...
DECLARE_RESOURCE_PACK(  6, CUBEMAPS,              "cubemaps",             "General");
DECLARE_RESOURCE_PACK(  7, DASHBOARDS,            "dashboards",           "General");
DECLARE_RESOURCE_PACK(  8, FAMICONS,              "famicons",             "LoadBeforeMap");
...
DECLARE_RESOURCE_PACK( 16, PARTICLES,             "particles",            "LoadBeforeMap");
