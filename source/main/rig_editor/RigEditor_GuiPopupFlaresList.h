...
class GuiPopupFlaresList: public GuiPopupDynamicListBase
{
public:
	...
	void ClearFlaresList() { ClearList(); }

	void UpdateFlaresList(std::vector<Flare*> flares_list);
...
protected:
	...
	void OnSelectAllMouseFocusGained       (MyGUI::MenuItem* menu_item, GuiWidgetUserdata* userdata);
	void OnSelectAllMouseFocusLost         (MyGUI::MenuItem* menu_item, GuiWidgetUserdata* userdata);
	void OnDeselectAllMouseFocusGained     (MyGUI::MenuItem* menu_item, GuiWidgetUserdata* userdata);
	void OnDeselectAllMouseFocusLost       (MyGUI::MenuItem* menu_item, GuiWidgetUserdata* userdata);
